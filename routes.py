...
# Added student_books_db as a variable and in render template, import the get_student_books function
...
def my_books():
    ...
    books_from_db = get_all_books()
    genres_from_db = get_genres()
    student_books_db = get_student_books(username)
    return render_template('my_books.html', title='My Books', username=username,
                           ...
                           student_books_db=student_books_db)
